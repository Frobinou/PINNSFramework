...
Pa = ParamsLotkaVoltera(alpha=0.67, beta=1.3, delta=1.0, gamma=1.0)
...
data_config = DataConfig(
    data_folder=Path("data/lotka_volterra.parquet"), lambda_data=1.0, batch_size=64, shuffle=True
)
...
ode_experiment_config = ODEExperiment(
    ...
    input_cols=[
        "t"
    ],  # "alpha", "beta", "delta", "gamma" not yet used as inputs, but could be in a more complex scenario
